...
export const ComingSoon = ({}: Props) => {
  return (
    <>
      <h1 className="mb-10 text-center font-headings text-4xl font-extrabold tracking-tight text-primary dark:text-ice sm:text-5xl lg:text-6xl">
        Coming soon
      </h1>
      <div className="relative mx-auto w-full max-w-lg">
        ...
        <div className="animate-blob animation-delay-2000 absolute top-0 -right-4 h-72 w-72 rounded-full bg-tertiary opacity-70 mix-blend-multiply blur-xl filter"></div>
